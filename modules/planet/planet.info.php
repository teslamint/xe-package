<?php
    ...
    class planetInfo extends Object {
        ...
        {
            return $this->get('twitter_uid');
        }

        function getTwitterAuthKey()
        {
            return $this->get('twitter_authkey');
        }

        function getTwitterAuthPush()
        {
            return $this->get('twitter_autopush')=='Y'?true:false;
        }
