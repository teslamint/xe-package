<?php
    ...
    $lang->msg_twitter_sync = 'twitterに書き込みを送る';
    $lang->msg_twitter_sync_q = 'twitterに書き込みを送信しますか？';
    $lang->twitter_uid = 'twitterアドレス';
    $lang->twitter_authkey = 'ユーザーキー';
    $lang->msg_twitter_activate = '自動送信設定されました。';
    $lang->msg_fail_auth_twitter = 'twitterの認証に失敗しました。';
    $lang->msg_success_auth_twitter = 'twitter認証に成功しました。';
    ...
    $lang->cmd_send_twitter = 'twitter送信';
    ...
    $lang->planet_use_twitter = 'twitter連動';
    $lang->about_use_twitter = '書き込みの内容がtwitterへ送信されます。';
