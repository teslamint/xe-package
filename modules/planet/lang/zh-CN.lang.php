<?php
    ...
    $lang->msg_twitter_sync = "发送到twitter";
    $lang->msg_twitter_sync_q = "你确定要发送吗？";
    $lang->twitter_uid = "twitter地址";
    $lang->twitter_authkey = "用户key";
    $lang->msg_twitter_activate = "自动发送";
    $lang->msg_fail_auth_twitter = "twitter认证失败。";
    $lang->msg_success_auth_twitter = "已成功获得twitter认证。";
    ...
    $lang->cmd_send_twitter = "发送到twitter";
    ...
    $lang->planet_use_twitter = "绑定twitter";
    $lang->about_use_twitter = "发布主题的同时发送到twitter。";
