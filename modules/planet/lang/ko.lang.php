<?php
    ...
    $lang->msg_twitter_sync = '트위터로 글 보내기';
    $lang->msg_twitter_sync_q = '트위터로 내 글을 전송하시겠습니까?';
    $lang->twitter_uid = '트위터 아이디';
    $lang->twitter_authkey = '비밀번호';
    $lang->msg_twitter_activate = '항상 자동으로 전송합니다';
    $lang->msg_fail_auth_twitter = '트위터 인증에 실패하였습니다';
    $lang->msg_success_auth_twitter = '트위터 인증에 성공하였습니다';
    ...
    $lang->planet_use_twitter = '트위터 연동';
    $lang->about_use_twitter = '글 작성시 twitter에 보내게 됩니다.';
