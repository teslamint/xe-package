<?php
    ...
    $lang->msg_twitter_sync = "傳送到twitter";
    $lang->msg_twitter_sync_q = "確定要傳送到twitter嗎？";
    $lang->twitter_uid = "twitter網址";
    $lang->twitter_authkey = "User Key";
    $lang->msg_twitter_activate = "自動傳送。";
    $lang->msg_fail_auth_twitter = "twitter認證失敗。";
    $lang->msg_success_auth_twitter = "twitter認證成功。";
    ...
    $lang->cmd_send_twitter = "twitter傳送";
    ...
    $lang->planet_use_twitter = "Twitter";
    $lang->about_use_twitter = "發表主題的同時也傳送到Twitter(http://twitter.com)。";
