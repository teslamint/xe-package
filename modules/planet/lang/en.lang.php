<?php
    ...
    $lang->msg_twitter_sync = "Send to Twitter";
    $lang->msg_twitter_sync_q = "Would you like to send a message to Twitter?";
    $lang->twitter_uid = "Twitter ID";
    $lang->twitter_authkey = "User Key";
    $lang->msg_twitter_activate = "Always Send to Twitter";
    $lang->msg_fail_auth_twitter = "Twitter authentication failed";
    $lang->msg_success_auth_twitter = "Twitter authentication was successful";
    ...
    $lang->planet_use_twitter = "Use Twitter";
    $lang->about_use_twitter = "When writing a message, users can send it to twitter(http://twitter.com).";
